...
/****** Object: SqlProcedure [dbo].[AddReportToCache] Script Date: 12/21/2020 8:27:51 AM ******/
SET ANSI_NULLS ON
GO
...
UPDATE	[aapssrs01_ReportServerTempDB].dbo.ExecutionCache WITH (ROWLOCK) -- had deadlocks caused by page lock escalation using rowlock to avoid it.
...
INSERT INTO [aapssrs01_ReportServerTempDB].dbo.ExecutionCache
