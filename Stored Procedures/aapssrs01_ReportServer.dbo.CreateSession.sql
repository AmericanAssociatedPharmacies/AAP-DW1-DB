...
/****** Object: SqlProcedure [dbo].[CreateSession] Script Date: 12/21/2020 8:38:55 AM ******/
SET ANSI_NULLS ON
GO
...
INSERT
   INTO [aapssrs01_ReportServerTempDB].dbo.SessionData (
      SessionID,
      CompiledDefinition,
      SnapshotDataID,
      IsPermanentSnapshot,
...
INSERT INTO [aapssrs01_ReportServerTempDB].dbo.SessionLock(SessionID)
VALUES (@SessionID)
